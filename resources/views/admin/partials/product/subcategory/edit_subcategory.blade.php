...
<div class="page-content">
    ...
    <div class="container-fluid">
        <form action="{{route('admin.update_subcategory',$subcategories->id)}}" method="post" id="categoryForm" name="categoryForm" enctype="multipart/form-data">
            @csrf
        <div class="card">
            <div class="card-body">	
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" id="slug" class="form-control" placeholder="Slug Ex.URL" value="{{ $subcategories->slug }}">	
