                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" id="slug" class="form-control" placeholder="Slug Ex.URL" value="{{ $category->slug }}">	
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            @if($category)
                            <img id="new_image" src="{{ asset('/upload/categoryimage/'.$category->image) }}" style="width: 200px; margin:5px;" >
                            @endif 
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea name="meta_description" id="meta_description" cols="30" rows="10" class="summernote" placeholder="Meta Description" value="{{ $category->meta_description }}">{{ $category->meta_description }}</textarea>
