                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="short_desc" id="short_desc" cols="30" rows="10" class="summernote" placeholder="short_desc" value="{{ old('short_desc') }}">{{ old('short_desc') }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="material" id="material" class="form-control" placeholder="material" value="{{ old('material') }}">	
                        ...
                        <label >Product Colours</label>
                            <div class="mb-3">
                                ...
                                <label style="font-weight: normal;" for="colour">
                                    <input type="checkbox" name="color[]" value="{{ $colour->name }}" class="me-2">{{ $colour->name }} <br>
                                </label>
                                @endif
                                @endforeach
                            ...
                            <label >Product Size</label>
                                <div class="mb-3">
                                    <label style="font-weight: normal;" for="size">
                                        <input type="checkbox" name="size[]" value="Extra-Small" class="me-2">Extra-Small <br>
                                        <input type="checkbox" name="size[]" value="Small" class="me-2">Small <br>
                                        <input type="checkbox" name="size[]" value="Medium" class="me-2">Medium <br>
                                        <input type="checkbox" name="size[]" value="Large" class="me-2">Large <br>
                                        <input type="checkbox" name="size[]" value="Extra-Large" class="me-2">Extra-Large
                                    </label>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="10" class="summernote" placeholder="Description" value="{{ old('description') }}">{{ old('description') }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="add_info" id="add_info" cols="30" rows="10" class="summernote" placeholder="Additional Information" value="{{ old('add_info') }}">{{ old('add_info') }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="meta_key" id="meta_key" class="form-control" placeholder="Meta Keyword" value="{{ old('meta_key') }}">	
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea name="meta_desc" id="meta_desc" cols="30" rows="10" class="summernote" placeholder="Meta Description" value="{{ old('meta_desc') }}">{{ old('meta_desc') }}</textarea>
