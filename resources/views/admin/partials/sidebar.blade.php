<nav class="sidebar">
    ...
    <div class="sidebar-body">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a href="{{ route('admin.view_subcategory') }}" class="nav-link">
            <i class="link-icon" data-feather="calendar"></i>
            <span class="link-title">Sub-Category</span>
          </a>
        </li>
        <li class="nav-item">
          <a href="{{ route('admin.view_brand') }}" class="nav-link">
            <i class="link-icon" data-feather="calendar"></i>
            <span class="link-title">Brand</span>
          </a>
        </li>
        <li class="nav-item">
          <a href="{{ route('admin.view_colour') }}" class="nav-link">
            <i class="link-icon" data-feather="calendar"></i>
        ...
        <li class="nav-item">
          <a href="{{ route('admin.view_order') }}" class="nav-link">
            <i class="link-icon" data-feather="calendar"></i>
